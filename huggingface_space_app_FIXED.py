#!/usr/bin/env python3
"""
HuggingFace Space - Qwen2.5-7B Distillation (FIXED)
Optimized for A10G small GPU (30-60 min)
"""

import gradio as gr
import torch
from model2vec.distill import distill  # FIXED: Correct import!
